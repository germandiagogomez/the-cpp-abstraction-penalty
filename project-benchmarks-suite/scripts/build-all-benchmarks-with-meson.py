...
MESON_INTROSPECT = os.environ['MESONINTROSPECT']
...
if __name__ == '__main__':
    ...
    for i, native_file in enumerate(NATIVE_FILES):
        configure_meson(native_file, build_dirs[i], verbose=True, raise_error=False, meson_setup_options=' '.join(sys.argv[1:]))
